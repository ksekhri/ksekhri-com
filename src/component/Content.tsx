...
const Content = () => (
  <section className="mx-auto mt-12 mb-11 flex max-w-screen-xl items-center px-8 md:mt-[5rem] md:mb-[4.5rem] lg:mt-[8rem] lg:mb-[7rem] xl:mt-[10rem] xl:mb-[9rem] xl:px-4 2xl:px-0">
    ...
    <div className="bg-slate-50 px-6 py-5 text-2xl dark:bg-slate-600 md:ml-5 md:px-8 md:py-8 lg:px-10 lg:py-12 xl:ml-7 xl:px-[5rem] xl:py-[4rem] 2xl:ml-11">
      <p className="mb-7">
